#line 1 "/Users/AlexanderBouman/Desktop/GradSchool/RExLab/SimpleQuad/src/imu_vicon_feather/src/imu_vicon/pose.hpp"
#pragma once
...
namespace rexlab
{
  ...
  std::ostream &operator<<(std::ostream &io, const Pose<T> &pose)
  {
    io << "Position: "
       ...
       << pose.quaternion_z << " Occluded? " << pose.is_occluded;
    return io;
  }
