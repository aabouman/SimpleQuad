#line 1 "/Users/AlexanderBouman/Desktop/GradSchool/RExLab/SimpleQuad/src/imu_vicon_feather/src/kalman/util/quad_types.h"
#ifndef QUAD_TYPES_H
#define QUAD_TYPES_H
...
template <typename T>
using err_state_state_jac_t = Matrix<float, EKF_NUM_ERR_STATES, EKF_NUM_STATES>;
// Jacobian mapping a measurement into an error measurement
template <typename T>
using err_measure_measure_jac_t = Matrix<float, EKF_NUM_ERR_MEASURES, EKF_NUM_MEASURES>;
